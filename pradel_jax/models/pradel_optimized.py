...
class OptimizedPradelModel(PradelModel):
    ...
    def _vectorized_log_likelihood(
        ...
        capture_probs = jnp.broadcast_to(phi[:, None], (n_individuals, n_occasions-1)) * \
        ...
        log_recapture = jnp.log(capture_probs + 1e-10)  # Add small epsilon for numerical stability
        ...
        first_capture_loglik = jnp.where(
            was_captured,
            jnp.log(p + 1e-10),
            0.0
        )
