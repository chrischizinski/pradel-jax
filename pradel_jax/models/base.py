...
class CaptureRecaptureModel(ABC):
    ...
    def validate_formula(self, formula_spec: FormulaSpec, data_context: DataContext) -> None:
        """
...
class ModelRegistry:
    ...
    def register(self, model_type: ModelType, model_class: Type[CaptureRecaptureModel]) -> None:
        """
        ...
        self.logger.info(f"Registered model: {model_type.value} -> {model_class.__name__}")
